========================================================================
    APLICACIÓN: CrearLista Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación CrearLista.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación CrearLista.
...
Form1.h
    Contiene la implementación de su clase de formulario y la función InitializeComponent().
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado CrearLista.pch y un archivo de tipos precompilados llamado StdAfx.obj.
